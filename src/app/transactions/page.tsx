...
export default function TransactionsPage() {
  ...
  // 📦 Busca transações filtradas por perfil
    ...
    await supabase.from('transactions').insert([
      {
        ...
        due_date: newTransaction.due_date || new Date().toISOString().slice(0, 10),
  ...
  const saveEdit = async () => {
    ...
    await supabase
      ...
      .update({
        ...
        due_date: editedTransaction.due_date,
  ...
  return (
    <div className="p-10 bg-[#F8F9FA] dark:bg-[#0d0d0d] min-h-screen flex flex-col gap-8 transition-colors duration-300">
      ...
      <div className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          <select
            ...
            className="border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 rounded-lg p-2 w-full md:w-32 focus:ring-2 focus:ring-[#D4AF37]"
          >
          ...
          <input
            ...
            className="border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 rounded-lg p-2 w-full md:w-40 focus:ring-2 focus:ring-[#D4AF37]"
          />
          ...
          <input
            ...
            className="border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 rounded-lg p-2 w-full focus:ring-2 focus:ring-[#D4AF37]"
          />
          ...
          <input
            ...
            className="border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 rounded-lg p-2 w-full md:w-48 focus:ring-2 focus:ring-[#D4AF37]"
          />
      ...
      {/* Lista */}
      <div className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
        <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-[#D4AF37]">Histórico</h2>
        ...
        {loading ? (
          ...
          <div className="flex flex-col divide-y divide-gray-200 dark:divide-gray-800">
            {transactions.map((tx) => (
              <div key={tx.id} className="flex justify-between items-center py-3 text-gray-700 dark:text-gray-200">
                {editingId === tx.id ? (
                  <div className="flex flex-1 items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditedTransaction({ ...editedTransaction, due_date: e.target.value })
                      }
                  ...
                  <>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium">{tx.category || 'Sem categoria'}</p>
